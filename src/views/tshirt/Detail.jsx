	...
	return (
					<div className="row mb-3">
						<div className="col-md-5 text-center">
							<img
								src="../../images/tshirts/tshirt_red_480x400.webp"
								className="img-fluid mb-3"
								alt=""
							/>
							<img
								src="../../images/tshirts/tshirt_grey_480x400.webp"
								className="border border-secondary me-2" width="75"
								alt="..."
							/>
							<img
								src="../../images/tshirts/tshirt_black_480x400.webp"
								className="border border-secondary me-2" width="75"
								alt="..."
							/>
							<img
								src="../../images/tshirts/tshirt_green_480x400.webp"
								className="border border-secondary me-2" width="75"
								alt="..."
							/>
						</div>
				...
				<div className="col-md-4">
					<CardFeaturedTShirt data={data.tshirts} />
					<CardServices />
				</div>
			</div>
		</div>
